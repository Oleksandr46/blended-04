...
const listTitels = document.querySelectorAll("h3");
console.log("🚀 ~ listTitels:", listTitels);
// 9 - для кожного елмента h3 додай class="active", який змінить колір заголовка на червоний колір
listTitels.forEach(title => title.classList.add("active"));
...
console.log("🚀 ~ topicNav:", topicNav);
// 11 - додай для знайденого елемента data-topic="navigation" атрибут style і зроби його backgroundColor жовтим
topicNav.setAttribute("style", "background-color: yellow");
